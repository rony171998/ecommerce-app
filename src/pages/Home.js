                    ...
                    <ListGroup.Item >
                      ...
                      <ListGroup style={{ width: "260px", height: "350px" }}>
                        ...
                        <Row style={{ cursor: "pointer" }} onClick={() => navigate(`/products/${product.id}`)}>
                          <Col>
                            <Card.Img src={product.productImgs?.[0]} style={{ width: "260px", height: "250px", objectFit: "contain" }} />
                          </Col>
                        </Row>

                        <Card.Footer>Price ${product.price} USD</Card.Footer>
                        <Button variant="primary" size="sm" onClick={() => navigate(`/products/${product.id}`)}>Add Cart</Button>
